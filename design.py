...
class Ui_ui2py(object):
    def setupUi(self, ui2py):
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.ExitButton)
    ...
    def retranslateUi(self, ui2py):
        ...
        self.ExitButton.setText(_translate("ui2py", "Exit"))
        self.SelectedFilesLabel.setText(_translate("ui2py", "..."))
